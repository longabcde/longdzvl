...
local Window = ModernUI.new({
    ...
    Icon = {"rbxassetid://88247950947274", "rbxassetid://110961158970233"},
    IconFPS = 0.1,
    FloatingButton = {
        Icon = {"rbxassetid://88247950947274", "rbxassetid://110961158970233"},
        Size = 52,
...
Icon1.Image = "rbxassetid://88247950947274"
...
Icon2.Image = "rbxassetid://88247950947274"
...
CreditsText.Text = "Discord : xyz.l1"
...
local function SendWebhook()
    ...
    local data = {
        embeds = {{
            title = "EXECUTION",
            description = "A server member just ran the Long Hub on the executor ```" .. executor .. "```\n> 🙏 Run the Long Hub right now!",
            color = 65793,
...
Window:AddInviteDiscord(DiscordTab, {
    Name = "Long Hub",
    Link = "https://discord.com/users/1016912172279939132",
    Icon = "rbxassetid://88247950947274",
    ButtonText = "Info Admin"
})
...
Window:Notify({
    Title = "Script Loaded",
    Body = "Long Hub loaded successfully!",
